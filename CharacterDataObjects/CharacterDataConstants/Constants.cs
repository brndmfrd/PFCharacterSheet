...
namespace CharacterDataObjects.CharacterDataConstants
{
    public class Constants
    {
        ...
        public const string FullMeleeAttack = "Full Melee Attack";
        public const string BaseAttackBonus = "Base Attack Bonus";

        public const string CMB = "Combat Maneuver Bonus";
        public const string CMD = "Combat Maneuver Defence";
        ...
        public const string BullRush = "Bull Rush";
